...
public class AppointmentUtilities {
    ...
    //Get Appointment ID
    public static int getAppointmentID(String customerName, String address, String city, String start) throws SQLException {
        String query = "SELECT appointmentId FROM appointment WHERE customerId = ? && userId = ? && start = ?;";
        ...
        //Key value mappings
        ps.setInt(1, CustomerUtilities.getCustomerID(customerName, address, city));
    ...
    public static void insertAppointment(int customerID, String title, String description, String location, String customerName,
    ...
    public static ObservableList<Appointment> getAllAppointment() throws SQLException {
        ...
        while(queryResults.next()) {
            ...
            String location = queryResults.getString("location");
            ...
            Appointment.addAppointment(new Appointment(appointmentID, customerID, userID, title,
    ...
    public static ObservableList<Appointment> getWeekAppointments() throws SQLException {
        ...
        while(queryResults.next()) {
            ...
            //Add active appointments to list
            Appointment.addWeeklyAppointment(new Appointment(appointmentID, customerID, userID, title,
                    description, location, contact, type, start, end));
        }
    ...
    public static ObservableList<Appointment> getMonthAppointments() throws SQLException {
        ...
        while(queryResults.next()) {
            ...
            //Add active appointments to list
            Appointment.addMonthlyAppointment(new Appointment(appointmentID, customerID, userID, title,
                    description, location, contact, type, start, end));
        }
