...
public class CustomerUtilities {
    ...
    //Get Customer ID
    public static int getCustomerID(String customerName, String address, String city) throws SQLException {
    ...
    public static ObservableList<Customer> getCustomer(int customerId) throws SQLException {
        ...
        while(queryResults.next()) {
            ...
            Customer.addUpdateCustomer(new Customer(customerID, customerName, addressID, address, address2,
    ...
    public static ObservableList<Customer> getAllCustomers() throws SQLException {
        ...
        while(queryResults.next()) {
            ...
            Customer.addCustomer(new Customer(customerID, customerName, addressID, address, address2,
                    cityID, city, countryID, country, postalCode, phone));
        }
