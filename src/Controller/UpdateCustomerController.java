...
public class UpdateCustomerController implements Initializable {
    ...
    void OnClickSave(MouseEvent event) throws IOException, SQLException {
        ...
        if(country.isEmpty() || city.isEmpty() || address.isEmpty() || postalCode.isEmpty() ||
            ...
            CustomerUtilities.updateCustomer(customerID, name, addressID);
...
//    Get customer details from Main Screen Controller for which customer record to update
    public void getCustomerDetails(Customer customer, int customerId) {
        customerID = customerId;

        NameTxt.setText(customer.getCustomerName());
        NumberTxt.setText(customer.getPhone());
        AddressTxt.setText(customer.getAddress());
        AddressTxt2.setText(customer.getAddress2());
